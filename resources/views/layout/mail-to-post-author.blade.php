...
<div class="email-body" style="background-color:#fff ; margin: 30px auto">
    ...
    <div class="email-post">
        ...
        <img style="display:block;margin: 0 auto;max-width:100%;" src="{{$data->fistImage()}}" alt="">
        ...
        <div style="width:100%;">
            <div class="button">
                ...
                href="{{route('post.update.email.url',$data->uuid)}}">Update
                    advertencia</a>
            </div>
        
            <div class="button">
                <a style="color: #fff;background: #f44336; border-radius: 5px;"
                href="{{route('delete.user.post.from.email.url',$data->uuid)}}">Delete
                    advertencia</a>
            </div>
        </div>
    ...
    <div class="post-details">
        <p>Prijs : 12.50 AWG pa cada dia . <br>cuenta di banco CMB: 1234566. <br>description : #{{$data->id}}</p>
    </div>
    -->
