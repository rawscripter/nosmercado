...
<head>
    ...
    <!-- plugins:css -->
    <link rel="stylesheet" href="<?php echo e(asset('assets/admin/vendors/iconfonts/font-awesome/css/all.min.css')); ?>">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row default-layout-navbar">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
            <a class="navbar-brand brand-logo" href="/">
                <img src="<?php echo e(asset('images/logo.png')); ?>" width="120px" alt="Nosmercado">
            </a>
    ...
    <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            <ul class="nav">
                <li class="nav-item nav-profile">
                    <div class="nav-link">
                        <div class="profile-image">
                            <img src="<?php echo e(asset('assets/admin/images/faces/face5.jpg')); ?>" alt="image"/>
                        </div>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('admin.posts')); ?>">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('admin.archive.posts')); ?>">
...
<?php /**PATH C:\xampp\htdocs\projects\fiverr\nosmercado\resources\views/layouts/admin/layout.blade.php ENDPATH**/ ?>